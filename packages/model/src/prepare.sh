...
python train.py --wandb "" --proj_dir $PROJ_DIR \
 --data_file "/home/arthur/projects/AItuneCraft/packages/model/src/midiData/piano_text_document"  --data_type "binidx" --vocab_size $VOCAB_SIZE --my_testing $MODEL_TYPE \
