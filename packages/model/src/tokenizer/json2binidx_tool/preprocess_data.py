...
import ftfy
import json2binidx_tool.indexed_dataset as indexed_dataset
import tqdm
from json2binidx_tool.tokenizer import build_tokenizer
...
def get_args(input: Optional[str], out: Optional[str], vocab: Optional[str]):
...
def startTheProsses(input: Optional[str], out: Optional[str], vocab: Optional[str]):
    args = get_args(input, out, vocab)
...
if __name__ == "__main__":
    startTheProsses(None, None, None)
