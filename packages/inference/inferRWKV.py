...
def mixTheSongs(song_len, ctx, out_len, te = 1.0):
    pinio, drum = genrateTheSong(ctx, out_len,
        ...
        genrateTheSong(
            ctx, out_len, "/home/arthur/AItuneCraft/packages/model/drumL20-D512-x0601/rwkv-final.pth", te)
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument(
        "-te", "--temperature", help="Enter the temperature of model", default=1.5, type=float
    )
    ...
    if args.midi is not None:
        ...
        raise Exception("Context is needed")

    mixTheSongs(args.song_len, context, args.out_len, args.te)
